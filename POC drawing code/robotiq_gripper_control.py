'''
Example code for controlling a robotiq gripper using the ur_rtde robot interface.
Will be used in the future to pick up the pen and stamp.
I've not yet played around with this.
'''
